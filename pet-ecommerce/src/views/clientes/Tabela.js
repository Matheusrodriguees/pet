          ...
          customBodyRenderLite: (dataIndex, rowIndex) => {
            return (
              <div>
                ...
                <RouterLink
                  to={"/app/editar-cliente/" + this.props.data[dataIndex].id}
                >
                  <CreateIcon style={{ fill: "#000" }} />
                </RouterLink>
                ...
                <DeleteOutlineIcon
                  ...
                  onClick={async () => {
                    if (
                      window.confirm("Deseja realmente inativar este cliente?")
                    ) {
                      //auxiliar salva valores de todas as linhas
                      let auxData = this.props.data;
                      axios.put("/cliente/inativar/" + auxData[dataIndex].id);
      ...
      },
      {
        ...
        options: {
          ...
          customBodyRenderLite: (dataIndex, rowIndex) => {
            return (
              <div>
                {moment(this.props.data[dataIndex].dataNascimento).format(
                  "DD/MM/YYYY"
                )}
              </div>
            );
      ...
      },
      {
        ...
        options: {
          ...
          customBodyRenderLite: (dataIndex, rowIndex) => {
            return (
              <div>
                ({this.props.data[dataIndex].ddd}){" "}
                {this.props.data[dataIndex].telefone}
              </div>
            );
          },
        },
      ...
      },
      {
        ...
        options: {
          ...
          customBodyRenderLite: (dataIndex, rowIndex) => {
            return (
              <div>
                {moment(this.props.data[dataIndex].criado_em).format(
                  "DD/MM/YYYY h:mm"
                )}
              </div>
            );
      ...
      },
      {
        ...
        options: {
          ...
          customBodyRenderLite: (dataIndex, rowIndex) => {
            return (
              <div>
                {moment(this.props.data[dataIndex].atualizado_em).format(
                  "DD/MM/YYYY h:mm"
                )}
              </div>
            );
